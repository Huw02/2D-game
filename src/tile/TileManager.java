...
public class TileManager {
    ...
    public void getTileImage (){
        try{
            ...
            //tile [9] = new Tile();
            //tile [9].image = ImageIO.read(getClass().getResourceAsStream("/tiles/congo.png"));
...
// tegner vores verden
    public void draw(Graphics2D g2){
        ...
        while(worldCol< gp.maxWorldCol && worldRow < gp.maxWorldRow){
            ...
            //optimere spillet ved kun at tegne den del man kan se på skærmen og ikke hele spillet.
